    ...
    return UIComponent.extend("com.deloitte.mdg.purchase.pricing.approver.Component", {
        ...
        createContent: function () {
            if (!this._mainView) {
                this._mainView = sap.ui.view({
                    id: "taskView",
                    viewName: "com.deloitte.mdg.purchase.pricing.approver.view.Overview",
                    type: "XML"
                });
            }
        ...
        _addApproveComment: async function () {
            ...
            for (let c of newComments) {
                await fetch(`${base}PurchasePricingComments`, {
                    method: "POST",
                    headers: {
        ...
        _updateRequestStatus: async function (reqStatus, wfStatus) {
            ...
            await fetch(`${base}PurchasePricingRequests(requestId='${requestId}')`, {
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRF-Token": token
        ...
        _createSinglePricingCondition: function (row) {
            ...
            return new Promise((resolve, reject) => {
                ...
                this.getModel("SAPPurchaseModel").create(
        ...
        _refreshSAPCsrf: function () {
            return new Promise((resolve, reject) => {
                const oModel = this.getModel("SAPPurchaseModel");
        ...
        _openResultDialog: function (title, message, state) {
            ...
            if (!this._resultDialog) {
                this._resultDialog = sap.ui.xmlfragment(
                    "com.deloitte.mdg.purchase.pricing.approver.view.fragments.ResultDialog",
                    this
                );
